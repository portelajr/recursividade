## Sobre o Projeto:
- Projeto executado durante o módulo de ciência da computação da escola técnica da Trybe.
- Aplicabilidade de conceitos de Estrutura de dados e Recusividade no desenvolvimento de Algoritmos
- Linguagem utilizada: Pyhton.
...
### Habilidades a serem Testadas

  - Noções em Estrutura de dados
